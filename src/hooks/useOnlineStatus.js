 ...
 *
 * This is now the one place anything in the app should go to ask "are we
 * really online" (plan §2.4) — nothing else currently reads navigator.onLine
 * directly, so no other file needs to change for this update.
 *
